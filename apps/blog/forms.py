...
class CommentForm(forms.Form):
    ...
    评论表单
    '''
    name = forms.CharField(widget=forms.TextInput(attrs={"id": "author", "class": "comment_input",
    ...
    phone = forms.URLField(widget=forms.TextInput(attrs={"id": "url", "type": "", "class": "comment_input",
                                                       "size": "25", "tabindex": "3"}),
